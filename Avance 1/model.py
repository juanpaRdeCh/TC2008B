...
class CityModel(Model):
    ...
    def __init__(self, N):
        ...
        with open("city_files/2022_original.txt") as baseFile:
                    ...
                    for neighbor in neighbors:
                        ...
                        if any(
                            ...
                            if isinstance(current_agent, Road):
                                ...
                                elif direction == "Up-Right" and x < neighbor[0]:
                                    G.add_edge(
                                        current_node,
                                        neighbor,
                                        weight=1,
                                ...
                                elif direction == "Up-Right" and y < neighbor[1]:
                                    G.add_edge(
                                        current_node,
                                        neighbor,
                                        weight=1,
                                ...
                                elif direction == "Down-Right" and x < neighbor[0]:
                                    G.add_edge(
                                        current_node,
                                        neighbor,
                                        weight=1,
                                ...
                                elif direction == "Down-Right" and y > neighbor[1]:
                                    G.add_edge(
                                        current_node,
                                        neighbor,
                                        weight=1,
                                ...
                                elif direction == "Down-Left" and x > neighbor[0]:
                                    G.add_edge(
                                        current_node,
                                        neighbor,
                                        weight=1,
                                ...
                                elif direction == "Down-Left" and y > neighbor[1]:
                                    G.add_edge(
                                        current_node,
                                        neighbor,
                                        weight=1,
